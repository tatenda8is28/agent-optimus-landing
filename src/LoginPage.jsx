...
export default function LoginPage() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // The useEffect hook above will now handle all redirection logic.
        } catch (error) {
            console.error(error);
    ...
    // Show a loading/redirecting message if the user is logged in
    // but the redirect hasn't happened yet.
    if (user) {
        return <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', height: '100vh' }}>Authenticating...</div>;
    }
