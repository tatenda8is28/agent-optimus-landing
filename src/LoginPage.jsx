...
export default function LoginPage() {
    ...
    const handleGoogleSignIn = async () => {
        ...
        try {
            ...
            // After popup, the useEffect above will handle the redirect.
        } catch (error) {
            console.error(error);
