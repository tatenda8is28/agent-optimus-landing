...
export default function LoginPage() {
    ...
    useEffect(() => {
        if (user) {
            ...
            // If user exists but profile is still loading, the effect will re-run when profile loads.
        }
    }, [user, userProfile, isAdmin, isNewUser, navigate]);
