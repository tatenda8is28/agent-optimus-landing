...
import { SalesPlaybookBuilder } from './components/SalesPlaybookBuilder.jsx';
    ...
    return (
        <div>
            ...
            <div className="tab-content-wrapper">
                {activeTab === 'playbook' && <SalesPlaybookBuilder playbookData={playbookData} onPlaybookChange={handlePlaybookChange} />}
