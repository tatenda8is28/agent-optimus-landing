...
const defaultPlaybook = { greeting_yes: "Great! When would suit you best – today, tomorrow, or this weekend? I’ll confirm what’s possible and get back to you shortly.", greeting_no: "No problem 😊 May I ask what you’re ideally looking for so I can send you a few matching options?", booking_style: "MANUAL", booking_manual_prompt: "Great! I've noted your interest in viewing. What day and time work best for you?", booking_manual_confirm: "Perfect, thanks! I've noted your preference for [Time Provided by User]. Michael will now personally contact the seller to confirm and will be in touch with you shortly to finalize the appointment.", qualification_steps: [ { id: 'timeline', enabled: true, question: "While that's being processed, could you let me know how soon you are looking to purchase?" }, { id: 'finance', enabled: true, question: "And will you be purchasing with cash, with a bond, or subject to the sale of another property?" } ], finance_handoff: { enabled: true, specialist_name: "Adel", specialist_email: "adel@example.com", handoff_message: "No problem, our specialist, [Specialist Name], can assist with that. I've sent her your details, and she will be in touch." }, further_instructions: "Always maintain a casual and helpful tone. If a user asks a question you don't know the answer to, respond with: \"That's a great question. I need to confirm with Michael and I'll get right back to you.\"" };
